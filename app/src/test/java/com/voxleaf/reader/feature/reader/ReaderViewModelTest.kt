...
import com.voxleaf.reader.tts.TtsState
...
class ReaderViewModelTest {
    ...
    private val readerThemeFlow = MutableStateFlow("NIGHT")
    private val readerFontFamilyFlow = MutableStateFlow("SERIF")
    private val readerFontSizeFlow = MutableStateFlow(18)
    private val readerLineSpacingFlow = MutableStateFlow(1.75f)
    ...
    fun setup() {
        ...
        every { appSettingsManager.readerThemeFlow } returns readerThemeFlow
        every { appSettingsManager.readerFontFamilyFlow } returns readerFontFamilyFlow
        every { appSettingsManager.readerFontSizeFlow } returns readerFontSizeFlow
        every { appSettingsManager.readerLineSpacingFlow } returns readerLineSpacingFlow
    }
